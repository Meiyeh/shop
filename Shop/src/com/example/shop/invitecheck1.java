...
public class invitecheck1 extends Activity {
	private TextView t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15;
	private String uid,uname,name,thing,money,goal,now,deadline,location,total,smath,tel,ip01,ip02;
	private int math;
	int n1,n2,tol;
	double stol;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.invitecheck1);
	...
	public void back(View view){
		...
		intent.setClass(invitecheck1.this,personal.class);
	...
	public void go(View view){
		Intent intent=new Intent();
		intent.setClass(invitecheck1.this,invitecheck3.class);
		Bundle bundle=new Bundle();
    	...
    	bundle.putString("location",location);//uid
    	bundle.putString("goal",goal);//uname
    	bundle.putString("now",now);//uid
    	bundle.putString("deadline",deadline);//uname
    	bundle.putString("tel",tel);//uname
    	bundle.putString("ip01",ip01);//uid
    	bundle.putString("ip02",ip02);//uname
		intent.putExtras(bundle);
		startActivity(intent);
	}
