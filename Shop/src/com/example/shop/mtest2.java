...
public class mtest2 extends AsyncTask<String,Void,String>{
		private Context context;
		private String uid,uname,name,many,money,location;
		public mtest2(Context context) {
		...
		protected String doInBackground(String... arg0) {
			...
			try{
				...
				String link="http://120.105.129.75/shop/test7.php";
		...
		protected void onPostExecute(String result){
			if(result.equals("")){
		    	...
		    	center2.setClass(context,mview3.class);
