...
public class updatejoin2 extends AsyncTask<String,Void,String>{
		private Context context;
		public updatejoin2(Context context) { 
		...
		protected String doInBackground(String... arg0) {
			try{
				...
				String thing = (String)arg0[2];
				String location = (String)arg0[3];
				String goal = (String)arg0[4];
				String now = (String)arg0[5];
				String deadline = (String)arg0[6];
				String telephone= (String)arg0[7];
				String longitude= (String)arg0[8];
				String latitude= (String)arg0[9];
				String link="http://120.105.129.75/shop/updatejoin2.php";
