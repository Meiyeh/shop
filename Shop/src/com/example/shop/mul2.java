...
public class mul2 extends Activity {
	GoogleMap gmap;
	Marker marker;
	float zoom;
	...
	private String uid,uname,id,name,money,intr,goal,now,dead,location;
	private int math;
	private Spinner spn_county,spn_city;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final TextView txtView = (TextView)findViewById(R.id.Address);
        ...
        spn_city.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                try{
                	Geocoder geoCoder = new Geocoder(mul2.this, Locale.getDefault());
	...
	public void go(View view){
		...
		intent.setClass(mul2.this,mul3.class);
	...
	public void back(View view){
		Intent intent=new Intent();
		intent.setClass(mul2.this,mul1.class);
		Bundle bundle=new Bundle();
		bundle.putString("uid",uid);//uid
    	bundle.putString("uname",uname);//uname
    	bundle.putString("id",id);//cid
