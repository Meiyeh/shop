...
public class update2 extends AsyncTask<String,Void,String>{
		...
		protected String doInBackground(String... arg0) {
			try{
				...
				String mul = (String)arg0[5];
				String link="http://120.105.129.75/shop/test5.php";
			    ...
			    data += "&" + URLEncoder.encode("mul", "UTF-8") + "=" + URLEncoder.encode(mul, "UTF-8");
