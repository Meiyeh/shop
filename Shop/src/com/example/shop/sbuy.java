...
public class sbuy extends AsyncTask<String,Void,String>{
		private Context context;
		private String id,uname;
		public sbuy(Context context) {
		...
		protected String doInBackground(String... arg0) {
			...
			try{
				id = (String)arg0[0];
				uname = (String)arg0[1];
				String link="http://120.105.129.75/shop/test3.php";
		...
		protected void onPostExecute(String result){
			if(result.equals("")){
		    	...
		    	center2.setClass(context,sbuyinf.class);
