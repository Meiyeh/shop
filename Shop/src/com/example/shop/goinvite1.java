...
public class goinvite1 extends AsyncTask<String,Void,String>{
		private Context context;
		private String uid,uname,ip01,ip02;
		public goinvite1(Context context) { 
		...
		protected String doInBackground(String... arg0) {
			try{
				...
				ip01 = (String)arg0[4];
				ip02 = (String)arg0[5];
				String link="http://120.105.129.75/shop/goinvite1.php";
		...
		protected void onPostExecute(String result){	
			...
			if(result.equals("")){
		    	...
		    	bundle.putString("ip01",ip01);
		    	bundle.putString("ip02",ip02);
		    	Intent center2=new Intent();
		    	center2.putExtras(bundle);
		    	center2.setClass(context,invitecheck1.class);
